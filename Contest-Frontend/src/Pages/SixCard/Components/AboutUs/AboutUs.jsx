  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="my-2 text-left text-xl font-semibold">
      ...
      <p className=" text-2xl font-semibold text-center   card-bordered shadow rounded text-[#38b6ff]  py-1 mt-5">
        -: Team Member :-
      </p>

      <p className=" text-2xl font-semibold text-[#00bf63] mt-6">Team Leader</p>
      <div className="mb-10">
        ...
        <p className=" text-right text-2xl font-semibold mt-10 text-[#00bf63]">
          App Designer
        </p>
        <div className=" shadow p-3 flex justify-between rounded">
          <div>
            <p className=" text-2xl font-semibold mb-2">Saimon Chowdhury </p>
            <p
              style={{
                display: "flex",
                justifyContent: "start",
        ...
        <p className=" text-left text-2xl font-semibold mt-10 text-[#00bf63]">
          Data Analyst
        </p>
        <div className=" shadow p-3 flex justify-between rounded">
          <div className="avatar text-center">
          ...
          <div>
            <p className=" text-2xl font-semibold mb-2">Ikhtiyar Ovi </p>
            <p
              style={{
                display: "flex",
                justifyContent: "start",
